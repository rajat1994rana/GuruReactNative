...
const FollowerDetailsScreen = ({navigation, route}) => {
          ...
          <FastImage source={ImagePath.profileBG} style={styles.bgImage}>
            <View style={styles.bgWrapper}>
              <View style={styles.headerView}>
                ...
                <Image source={ImagePath.moreWhite} style={styles.headerIcon} />
               </TouchableOpacity>
              </View>
              ...
              <View style={{alignItems: 'center'}}>
                ...
                <>
                      <TouchableOpacity style={styles.followingBtn}>
                        ...
                        <Image
                          source={ImagePath.userTick}
                          style={styles.followTick}
                        />
                      </TouchableOpacity>
...
export default FollowerDetailsScreen;
